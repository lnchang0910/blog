...
class CreateSpotTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('spot', function (Blueprint $table) {
            ...
            $table->string('spot_image1', 255)->nullable()->default('');
            $table->string('spot_image2', 255)->nullable()->default('');
            $table->string('spot_image3', 255)->nullable()->default('');
            $table->string('spot_image4', 255)->nullable()->default('');
            $table->string('spot_image5', 255)->nullable()->default('');
            $table->string('spot_voice', 255)->nullable()->default('');
            $table->string('spot_mov_file', 255)->nullable()->default('');
